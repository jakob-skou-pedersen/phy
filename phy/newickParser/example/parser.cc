...
const int YY_Parser_CLASS::DOUBLE=259;
const int YY_Parser_CLASS::DONE=260;
...
static const short yyrline[] = { 0,
    31,    34,    38,    44,    50,    56,    61,    66,    71,    76,
    81,    88,    93,    98,   103,   108,   113,   118,   123,   128
};

static const char * const yytname[] = {   "$","error","$illegal.","INT","DOUBLE",
"DONE","'+'","'*'","UnaryMinus","'\\n'","'('","')'","'-'","lines","line","intExpr",
"doubleExpr",""
};
#endif
...
static const short yypact[] = {    26,
     5,-32768,-32768,-32768,    -1,    -1,    22,-32768,     1,    41,
-32768,    33,    35,-32768,-32768,-32768,    -1,    -1,-32768,    -1,
    -1,-32768,-32768,-32768,    -3,    12,-32768,-32768,    -3,    12,
-32768,-32768,    24,-32768
};
...
static const short yytable[] = {    12,
    14,     2,     3,    18,    13,    15,    17,    18,     5,    19,
     6,    25,    27,    11,    29,    31,    26,    28,    21,    30,
    32,    33,     1,    34,     2,     3,     1,    16,     2,     3,
     4,     5,     0,     6,     4,     5,     0,     6,    17,    18,
    20,    21,     0,    23,     0,    24,    20,    21,     0,    22
};

static const short yycheck[] = {     5,
     6,     3,     4,     7,     5,     6,     6,     7,    10,     9,
    12,    17,    18,     9,    20,    21,    17,    18,     7,    20,
    21,     0,     1,     0,     3,     4,     1,     7,     3,     4,
     9,    10,    -1,    12,     9,    10,    -1,    12,     6,     7,
     6,     7,    -1,    11,    -1,    11,     6,     7,    -1,     9
};
